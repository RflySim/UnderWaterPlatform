...
:split1
    ...
    start /realtime CopterSim.exe 1 %cntr% %CLASS_3D_ID% %DLLModel% %SimMode% %UE4_MAP% %IS_BROADCAST% %PosXX% %PosYY% %ORIGIN_YAW% %subStr% %UDPSIMMODE% %IsSysID% %ORIGIN_POS_Z%,%ORIGIN_ROLL%,%ORIGIN_PITCH%
